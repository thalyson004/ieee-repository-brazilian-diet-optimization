...
Current status (2026-09-24): three further high-occurrence links were checked against official TBCA records and their existing targets retained: generic ricotta, raw unsalted pistachio, and fresh watermelon pulp. The index now contains 84 target decisions; the regenerated active queue has 86 unresolved non-identity links. These decisions do not adjudicate environmental coefficients or recipe/ingredient details beyond the recorded target labels.
...
- The original map preserved no confidence score, reviewer identity, or target-selection rationale. The revised dated ledger now records 84 target decisions and their sources; it is not a complete record of the remaining 86 links or of all environmental equivalence questions.
