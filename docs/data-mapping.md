...
Current status (2026-09-25): the nutrition-target ledger contains 156 decisions and the active queue has 14 unresolved non-identity links (321 occurrences). The `Feijoada vegetariana` decision is specific to TBCA preparation BRC0172T; the salad decision is specific to POF key 8511102#99 and TBCA preparation BRC0404B; tomato-sauce lineage is POF `7004801#99` → BRC0100B; chocolate milk is supported by six POF records with historical C0034G → current fluid BRC0034G; and cornstarch porridge now maps to BRC0054G instead of the banana preparation BRC0055G using POF record `6500616#99`. The unsupported cacao-to-pitaya mapping was corrected to cocoa-pulp candidate BRC0071C from POF CACAU record `6806301#99`, but remains in the queue because the source does not establish pulp versus seed/bean and POF's historical code is shared with a jenipapo row. Residual uncertainties also remain for tomato straining, the Toddynho brand, and porridge ingredients/proportions. The explicit vegan cow-milk exclusion is preserved. These decisions do not prove the provenance of every generated recipe and are distinct from ingredient, preparation, and environmental-coefficient review. Latest audit and queue identifiers are `base-diet-audit_20260925T030311918856Z_4b33f073` and `mapping-review-queue-current_20260925T030312282855Z_852571b2`; all optimization outputs remain diagnostic while these evidence gates are open.
