...
Current status (2026-09-24): eight further high-occurrence links were checked against official TBCA records and their existing targets retained: coalho cheese, generic cream cheese, whole-flavored-yogurt average, requeijão sample average, cooked unsalted pinhão, raw red cabbage, the specified cooked chayote preparation, and salted butter. The index now contains 81 target decisions; the regenerated active queue has 89 unresolved non-identity links. These decisions do not adjudicate environmental coefficients or recipe/ingredient details beyond the recorded target labels.
...
- The original map preserved no confidence score, reviewer identity, or target-selection rationale. The revised dated ledger now records 81 target decisions and their sources; it is not a complete record of the remaining 89 links or of all environmental equivalence questions.
