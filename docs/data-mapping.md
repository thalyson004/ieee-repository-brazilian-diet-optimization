...
Current status (2026-09-25): the nutrition-target ledger contains 154 decisions and the active queue has 16 unresolved non-identity links. The `Feijoada vegetariana` decision is specific to TBCA preparation BRC0172T; the salad decision is specific to POF key 8511102#99 and TBCA preparation BRC0404B; the tomato-sauce target and footprint lineage is specific to POF key 7004801#99 and TBCA BRC0100B. The current TBCA record's “não peneirado” qualifier remains unverified for the source menu. These decisions do not prove the provenance of every generated recipe and are distinct from ingredient, preparation, and environmental-coefficient review. Current audit and queue identifiers are recorded at the top of `tests/README.md`; all optimization outputs remain diagnostic while these evidence gates are open.
...
The current code audit is regenerated from the active maps, diets, and dated adjudication index. The next refresh should report 154 recorded target decisions and 16 active non-identity links without a decision. The tomato-sauce adjudication corrected BRC0100B in the local nutrient snapshot to the current official values (45 kcal, 9.06 g total carbohydrate, 5.42 g available carbohydrate per 100 g); no complete refresh of all TBCA codes has been performed. Earlier checkpoints are historical snapshots. The audit previously found zero unmapped TBCA/environmental occurrences and 1,597 target violations under the diagnostic calculation; the violation count is sensitive to map changes and is not a quality score.
...
- The original map preserved no confidence score, reviewer identity, or target-selection rationale. The revised dated ledger now records 154 target decisions and their sources; it is not a complete record of the remaining 16 links or of all environmental equivalence questions.
