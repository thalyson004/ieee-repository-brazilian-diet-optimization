...
Current status (2026-09-24): nine additional generic or fully specified links were checked against official TBCA records and their existing targets retained: industrialized baked cheese bread, light ricotta, cream cracker, black raisins, salted baked moranga squash, raw green chives, powdered soluble soy extract, average simple sweet biscuits, and salted cooked/drained sweet corn. The index now contains 100 target decisions; the regenerated active queue has 70 unresolved non-identity links. The 28-test suite passed; `base-diet-audit_20260924T180209026571Z_68f01a41` reports 150/150 structurally valid plans and 1,582 diagnostic nutritional violations, and `mapping-review-queue-current_20260924T180209427610Z_f4648261` regenerated the 70-item queue. These decisions do not adjudicate environmental coefficients or recipe/ingredient details beyond the recorded target labels.
...
The current code audit is regenerated from the active maps, diets, and dated adjudication index. Latest checkpoint `base-diet-audit_20260924T174535195545Z_00fbbe78` reports 122 identity mappings, 91 non-identity targets with a recorded decision, and 79 without one (170 non-identity links total). Three active targets are shared by multiple source names; the audit found zero unmapped TBCA/environmental occurrences and 1,582 target violations under the diagnostic calculation. The violation count is sensitive to map changes and is not a quality score. The preceding checkpoint `base-diet-audit_20260924T164329756813Z_5bb00410` is a historical 41/129 snapshot.
...
For review, `archive/audits/food-mapping-review-queue.csv` and its JSON counterpart are a frozen triage artifact generated from the original audit snapshot; they list all 170 originally non-identity links, their historical targets, occurrence counts, profiles, and five ranked TBCA name suggestions. The current dated index contains 91 target decisions; a regenerated active queue currently has 79 original links without a recorded target decision. A normalized-name flag and similarity score help triage the preserved target: 95/170 links normalize to the same lexical form under removal of generic qualifiers, while eight historical links score below 0.4 and include obvious mismatches. Neither group is automatically accepted or corrected. The CSV also provides blank decision, approved-target, rationale, evidence, reviewer/date, and environmental-map adjudication fields; no row is pre-approved. Generate a fresh lexical queue with:
...
- The original map preserved no confidence score, reviewer identity, or target-selection rationale. The revised dated ledger now records 91 target decisions and their sources; it is not a complete record of the remaining 79 links or of all environmental equivalence questions.
