...
Current status (2026-09-24): four further target labels were confirmed against official TBCA records and retained: skim cow milk powder, raw turnip with peel, drained preserved hearts of palm averaged across Pupunha/Juçara, and sardine fillet preserved in oil. The index now contains 112 target decisions; the regenerated active queue has 58 unresolved non-identity links. The 28-test suite passed; `base-diet-audit_20260924T180850732662Z_c3340165` reports 150/150 structurally valid plans and 1,582 diagnostic nutritional violations, and `mapping-review-queue-current_20260924T180851114925Z_a805ffdd` regenerated the 58-item queue. These decisions do not adjudicate environmental coefficients or recipe/ingredient details beyond the recorded target labels.
