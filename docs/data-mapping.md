...
Update, 2026-09-24: the frozen initial queue has 170 non-identity links. Thirty-four nutrition-target decisions are now documented; 136 other original links remain unadjudicated. This does not establish ingredient or preparation equivalence, environmental-coefficient validity, or complete formulation matching. In particular, oil type, tofu salt, fluid-milk processing, coconut processing, pasta refinement, rice-cracker formulation, vegetable-risotto ingredients, couve variety, and the salted-couscous match remain uncertain; see the dated correction ledger below. Where later text in this document reports older review counts, treat those as historical snapshots superseded by this update and the dated ledger.

This document describes the exact mapping path used by the archived submission and the checks required by the revised study. It deliberately distinguishes exact identity from a non-identity link. The preserved files do not classify whether each changed name is a lexical normalization or a semantic substitution, so neither interpretation can be assumed without item-level review. Since the first audited snapshot, twelve nutrient-map errors have been corrected with official TBCA record evidence; the item-level decisions are documented in [`archive/audits/food-mapping-corrections-2026-09-24.md`](../archive/audits/food-mapping-corrections-2026-09-24.md). These twelve still require separate verification of environmental coefficients and preparation equivalence.
