...
Update, 2026-09-24: the frozen initial queue has 170 non-identity links. Twenty-two nutrition-target decisions are now documented; 148 other original links remain unadjudicated. This does not establish ingredient or preparation equivalence, environmental-coefficient validity, or complete formulation matching. In particular, oil type, tofu salt, pasta refinement, rice-cracker formulation, and the salted-couscous match remain uncertain; see the dated correction ledger below. Where later text in this document reports the older 12/158 count, treat that as a historical snapshot superseded by this update and the dated ledger.
