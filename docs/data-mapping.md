...
Current status (2026-09-25): the nutrition-target ledger contains 155 decisions and the active queue has 15 unresolved non-identity links. The `Feijoada vegetariana` decision is specific to TBCA preparation BRC0172T; the salad decision is specific to POF key 8511102#99 and TBCA preparation BRC0404B; tomato-sauce lineage is POF `7004801#99` → BRC0100B; and chocolate milk is supported by six POF records with historical C0034G → current fluid BRC0034G. Residual uncertainties remain for tomato straining and the Toddynho brand. The explicit vegan cow-milk exclusion is preserved. These decisions do not prove the provenance of every generated recipe and are distinct from ingredient, preparation, and environmental-coefficient review. Current audit and queue identifiers are recorded at the top of `tests/README.md`; all optimization outputs remain diagnostic while these evidence gates are open.
...
- The original map preserved no confidence score, reviewer identity, or target-selection rationale. The revised dated ledger now records 155 target decisions and their sources; it is not a complete record of the remaining 15 links or of all environmental equivalence questions.
