...
Update, 2026-09-24: the frozen initial queue has 170 non-identity links. Twenty-five nutrition-target decisions are now documented; 145 other original links remain unadjudicated. This does not establish ingredient or preparation equivalence, environmental-coefficient validity, or complete formulation matching. In particular, oil type, tofu salt, fluid-milk processing, coconut-water processing, pasta refinement, rice-cracker formulation, and the salted-couscous match remain uncertain; see the dated correction ledger below. Where later text in this document reports older review counts, treat those as historical snapshots superseded by this update and the dated ledger.
