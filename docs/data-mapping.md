...
Current status (2026-09-24): six further high-occurrence links were checked against official TBCA records and their existing targets retained: roasted salted peanut, raw peanut, roasted salted almond, peeled raw beetroot, raw chard, and fresh pineapple pulp. The index now contains 73 target decisions; the regenerated active queue has 97 unresolved non-identity links. These decisions do not adjudicate environmental coefficients or recipe/ingredient details beyond the recorded target labels.
...
- The original map preserved no confidence score, reviewer identity, or target-selection rationale. The revised dated ledger now records 73 target decisions and their sources; it is not a complete record of the remaining 97 links or of all environmental equivalence questions.
