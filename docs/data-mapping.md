...
Current status (2026-09-24): eight further fully specified links were checked against official TBCA records and their existing targets retained: raw Italian zucchini, green olives in brine drained, raw radish with peel, raw peach, raw cassava flour, cooked dried beef without oil, light canned solid tuna, and pasteurized cheese by sample average. The index now contains 108 target decisions; the regenerated active queue has 62 unresolved non-identity links. The 28-test suite passed; `base-diet-audit_20260924T180621181744Z_d7d1c0bb` reports 150/150 structurally valid plans and 1,582 diagnostic nutritional violations, and `mapping-review-queue-current_20260924T180621565179Z_5e989379` regenerated the 62-item queue. These decisions do not adjudicate environmental coefficients or recipe/ingredient details beyond the recorded target labels.
