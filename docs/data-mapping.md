...
Current status (2026-09-24): seven further generic or fully specified links were checked against official TBCA records and their existing targets retained: raw grape, raw chicory, raw spinach leaves, raw arugula, the average soy beverage, no-sugar jam by average flavor, and 65%-lipid interesterified unsalted margarine. The index now contains 91 target decisions; the regenerated active queue has 79 unresolved non-identity links. These decisions do not adjudicate environmental coefficients or recipe/ingredient details beyond the recorded target labels.
