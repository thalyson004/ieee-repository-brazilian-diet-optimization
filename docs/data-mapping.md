...
Update, 2026-09-24: the frozen initial queue has 170 non-identity links. Nineteen nutrition-target decisions are now documented; 151 other original links remain unadjudicated. This does not establish ingredient or preparation equivalence, environmental-coefficient validity, or complete formulation matching. In particular, oil type, pasta refinement, rice-cracker formulation, and the salted-couscous match remain uncertain; see the dated correction ledger below.
