...
Latest audit refresh (2026-09-24): 132 target decisions are indexed and the active queue has 38 unresolved links. The latest audit is `base-diet-audit_20260924T185236559532Z_4b1bfc41`; the queue refresh is `mapping-review-queue-current_20260924T185236909814Z_584f1746`. The 28-test suite passed after the latest two remappings (ciabatta and unbranded canned peas). An integrated rerun (GA smoke, LP scope/slack, missingness, ingredient-screen, portion-support, and 10-seed replication) is in progress. Ground-beef oil type, walnut/pecan identity, recipe formulation, ingredients, and environmental pairings remain unresolved.
