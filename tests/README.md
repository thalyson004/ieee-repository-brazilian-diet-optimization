...
Latest audit refresh (2026-09-24): 81 target decisions are indexed and the active queue has 89 unresolved links; see the experiment plan for run IDs and exact status. A duplicated natural-skim-yogurt TBCA label and generic raw walnut/pecan label are intentionally unresolved pending source specificity.
