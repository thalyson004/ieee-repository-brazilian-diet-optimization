...
Latest adjudication and sensitivity checkpoint (2026-09-25): the wrong banana-porridge target BRC0055G was replaced by BRC0054G using exact POF record `6500616#99` and historical code C0054G; the milk/sugar recipe remains unverified. The unsupported cacao-to-pitaya mapping was corrected to cocoa-pulp candidate BRC0071C using POF record `6806301#99`, but cacao remains unresolved because pulp versus seed/bean is not established and the historical POF code is shared with jenipapo. The active ledger has 156 target decisions and 14 unresolved target links (321 occurrences). Refreshed audits `base-diet-audit_20260925T030311918856Z_4b33f073` (150 valid plans, 12,670 food occurrences, 1,600 diagnostic nutrient violations), `mapping-review-queue-current_20260925T030312282855Z_852571b2` (14 unresolved names), and `profile-ingredient-audit_20260925T030313129465Z_a8cc3619` (364 rows; 359 pending, 3 target-specific recipe-evidence rows, 2 exclusions) confirm the state. The refreshed missingness audit `nutrient-missingness-audit_20260925T030313380897Z_d7ce5911` retains only 20.82%, 24.28%, and 21.51% of grams in strict complete-case pools for regular, vegetarian, and vegan profiles; it finds no complete-case candidates for mandatory breakfast/lunch in regular and vegan and for breakfast in vegan, so it does not support a primary complete-case policy. Environmental audit `environmental-source-audit_20260925T030313748492Z_243147db` again confirms all 1,170 coefficients align after rounding, but source-row ambiguity remains. `lp-profile-scope_20260925T030318922527Z_33af8214` passed.

The current 14-label sensitivity `food-mapping-exclusion-sensitivity_20260925T024820232971Z_5026a88b` and review `food-mapping-exclusion-review_20260925T030219207327Z_ce8ed847` passed at clean input commit `b17cd1cb04fef4fc6082c9f7a630d18f85c310bc`: 66 outputs per variant, ten paired seeds, valid profile scope, identical input hashes, and 24 groups in each outcome/computational family. Exclusion removes 23 regular, 151 vegetarian, and 147 vegan occurrences. Unadjusted bootstrap intervals exclude zero for 0/24 outcome groups and 8/24 computational groups. All 12 LP records returned solutions; 10 had strict solver status 0 and the two vegan LP-Meal outputs used penalized-slack fallback. The logged deterministic suite `unit-tests_20260925T030237865319Z_b406e9aa` passed 54 tests. These results remain diagnostic only, not manuscript results.
