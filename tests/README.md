...
Latest audit refresh (2026-09-24): 112 target decisions are indexed and the active queue has 58 unresolved links. The latest audit is `base-diet-audit_20260924T180850732662Z_c3340165`; the queue refresh is `mapping-review-queue-current_20260924T180851114925Z_a805ffdd`. A duplicated natural-skim-yogurt TBCA label and generic raw walnut/pecan label are intentionally unresolved pending source specificity.
